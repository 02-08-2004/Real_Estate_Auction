          ...
          <div style={{ width: "100%" }}>
            ...
            <div className="li li-1" style={{ marginBottom: 20 }}>
              ...
              <div style={{ display: "flex" }}>
                <button type="button" className={`role-btn ${role === "user" ? "active" : ""}`} onClick={() => handleRoleChange("user")}>User / Buyer</button>
                <button type="button" className={`role-btn ${role === "admin" ? "active" : ""}`} onClick={() => handleRoleChange("admin")}>Admin</button>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} autoComplete="off">
              <div className="li li-2" style={{ marginBottom: 16 }}>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <input className="login-input" type="text" placeholder="Your full name" value={name} onChange={e => setName(e.target.value)} required autoComplete="off" style={{ width: "100%", background: "#ffffff", border: "none", borderRadius: 8, padding: "12px 14px 12px 44px", fontSize: 14, color: "#111", fontFamily: "inherit" }} />
                </div>
              </div>
              ...
              <div className="li li-2" style={{ marginBottom: 16 }}>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <input className="login-input" type="email" placeholder="Enter your Email" value={email} onChange={e => setEmail(e.target.value)} required autoComplete="off" style={{ width: "100%", background: "#ffffff", border: "none", borderRadius: 8, padding: "12px 14px 12px 44px", fontSize: 14, color: "#111", fontFamily: "inherit" }} />
                </div>
              </div>
              ...
              <div className="li li-3" style={{ marginBottom: 12 }}>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <input className="login-input" type={showPw ? "text" : "password"} placeholder="Create password" value={password} onChange={e => setPassword(e.target.value)} required autoComplete="new-password" style={{ width: "100%", background: "#ffffff", border: "none", borderRadius: 8, padding: "12px 44px 12px 44px", fontSize: 14, color: "#111", fontFamily: "inherit" }} />
              ...
              <div className="li li-4" style={{ marginBottom: 20 }}>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <input className="login-input" type={showConfirm ? "text" : "password"} placeholder="Confirm password" value={confirm} onChange={e => setConfirm(e.target.value)} required autoComplete="new-password" style={{ width: "100%", background: "#ffffff", borderRadius: 8, padding: "12px 44px 12px 44px", fontSize: 14, color: "#111", fontFamily: "inherit", border: confirm && confirm !== password ? "2px solid #E8192C" : "none" }} />
