            ...
            <form onSubmit={handleSubmit}>
              <div className="li li-2" style={{ marginBottom: 16 }}>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <input className="login-input" type="email" placeholder="Admin email" value={email} onChange={e => setEmail(e.target.value)} required style={{ width: "100%", background: "#ffffff", border: "none", borderRadius: 8, padding: "12px 14px 12px 44px", fontSize: 14, color: "#111", fontFamily: "inherit" }} />
                </div>
              </div>
              ...
              <div className="li li-3" style={{ marginBottom: 24 }}>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <input className="login-input" type="password" placeholder="Admin password" value={password} onChange={e => setPassword(e.target.value)} required style={{ width: "100%", background: "#ffffff", border: "none", borderRadius: 8, padding: "12px 14px 12px 44px", fontSize: 14, color: "#111", fontFamily: "inherit" }} />
                </div>
              </div>
